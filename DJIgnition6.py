...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav") and ("Drums" in str(filepath) and "World" in str(filepath) and "Noise" not in str(filepath) and "OS" not in str(filepath) and "Blip" not in str(filepath) and "Euro" not in str(filepath)):
        ...
        if  filepath.endswith(".wav") and ("Bass" in str(filepath)) and ("Walk" in str(filepath)) :
        ...
        if  filepath.endswith(".wav") and ("Marimba" in str(filepath)) or ("Conga" in str(filepath)) or ("Dum" in str(filepath)) :
