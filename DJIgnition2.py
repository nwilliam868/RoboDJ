...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav") and ("Bass" in str(filepath)) and ("Easy Listening" in str(filepath))  or ("Bass" in str(filepath) and "Jazzy Feel" in str(filepath)) :
            contentbass.append(filepath)

        if  filepath.endswith(".wav") and ("Guitar" in str(filepath) and "Easy Listening" in str(filepath)) or ("Guitar" in str(filepath) and "Jazzy Feel" in str(filepath)) :
