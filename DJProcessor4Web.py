...
for ctr in range(150):
    ...
    try:
        ...
        oufil = "C:\\Users\\mysti\\Coding\RoboDJ\\static\\dubbeat" + str(ctr) + ".wav"
        newAudio.export(oufil, format="wav")
    except:
        print("File unreadable.")

for ctr in range(450):
    ...
    try:
        ...
        if dic == 7:
            ...
            back = AudioSegment.silent(duration = sil2)
            newAudio = front + newAudio + back
        oufil = "C:\\Users\\mysti\\Coding\RoboDJ\\static\\dubpad" + str(ctr) + ".wav"
        newAudio.export(oufil, format="wav")
    except:
        print("File unreadable.")

for ctr in range(750):
    ...
    try:
        ...
        if dic == 7:
            ...
            back = AudioSegment.silent(duration = sil2)
            newAudio = front + newAudio + back
        oufil = "C:\\Users\\mysti\\Coding\RoboDJ\\static\\dubpepper" +  str(ctr) + ".wav"
        newAudio.export(oufil, format="wav")
    except:
        print("File unreadable.")
...
for ctr in range(90):
    ...
    try:
        ...
        oufil = "C:\\Users\\mysti\\Coding\RoboDJ\\static\\dubbass" + str(ctr) + ".wav"
        newAudio.export(oufil, format="wav")
    except:
        print("File unreadable.")
...
for ctr in range(450):
    ...
    try:
        ...
        oufil = "C:\\Users\\mysti\\Coding\RoboDJ\\static\\dubkeys" + str(ctr) + ".wav"
        newAudio.export(oufil, format="wav")
    except:
        print("File unreadable.")
...
for ctr in range(300):
    ...
    try:
        ...
        oufil = "C:\\Users\\mysti\\Coding\RoboDJ\\static\\dubbrass" +  str(ctr) + ".wav"
        newAudio.export(oufil, format="wav")
    except:
        print("File unreadable.")
...
for ctr in range(450):
    ...
    try:
        ...
        oufil = "C:\\Users\\mysti\\Coding\RoboDJ\\static\\dubsynth" + str(ctr) + ".wav"
        newAudio.export(oufil, format="wav")
    except:
        print("File unreadable.")
